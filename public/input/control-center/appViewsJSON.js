...
let lookAround = document.getElementById('look-around');
...
function renderImage(views, count) {
    ...
    if (views[count].video) {
        ...
        lookAround.innerHTML = '<h4> Click and drag to look around. </h4>';
        audio2.pause();

    } else if (views[count].hypersleep) {
        missionBox.style.backgroundColor = "black";
        missionBox.innerHTML = '<h1 class="hypersleep-text"> Hypersleep Engaged </h1>';
        lookAround.innerHTML = '';
