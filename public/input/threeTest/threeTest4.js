...
let camera, scene, renderer, stats, parameters;
			...
			function init() {
				...
				const sprite1 = textureLoader.load( './images/threeSprites/snowflake1.png' );
				const sprite2 = textureLoader.load( './images/threeSprites/snowflake2.png' );
				const sprite3 = textureLoader.load( './images/threeSprites/snowflake3.png' );
				const sprite4 = textureLoader.load( './images/threeSprites/snowflake4.png' );
				const sprite5 = textureLoader.load( './images/threeSprites/snowflake5.png' );
